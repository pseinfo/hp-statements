...
export default ( {
  code: 'EUH209',
  translations: {
    bg: 'При употреба може да стане силно запалимо.',
    ...
    pl: 'Podczas stosowania może przekształcić się w substancję wysoce łatwopalną.',
    pt: 'Pode tornar-se facilmente inflamável durante o uso.',
    ro: 'Poate deveni foarte inflamabil în timpul utilizării.',
    sk: 'Pri používaní sa môže stať veľmi horľavou.',
