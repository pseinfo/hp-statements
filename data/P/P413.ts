...
export default ( {
  ...
  translations: {
    ...
    ro: 'Depozitați cantitățile în vrac mai mari de … kg/… lbs la temperaturi care să nu depășească … °C/…°F.',
    sk: 'Veľké množstvo s hmotnosťou nad … kg/… lbs uchovávajte pri teplote do … °C/…°F.',
